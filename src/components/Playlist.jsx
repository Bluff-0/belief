...
export default function Playlist() {
    ...
    const mood = ["fatigued & depressed", "depressed", "sad", "upset", "bit stressed", "neutral", "pleasant", "happy", "elated", "excited"]
    ...
    return (
        <Item style={{
            ...
            <Grid container spacing={2} xs={12}>
                ...
                <Grid xs={4}>
                    With the recently played tracks, your mood seems {mood[Math.floor(tracks.sentiment * 10)]}
                </Grid>
                <Grid xs={5}>
                    <ImageList cols={3}>
